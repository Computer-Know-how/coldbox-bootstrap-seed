...
* A cool Role entity
*/
component persistent="true" entityName="role" table="roles" cachename="role" cacheuse="read-write"{
	...
	property name="permissions" singularName="permission" fieldtype="many-to-many" type="array" lazy="extra" orderby="permission" cascade="all" cacheuse="read-write"
			  cfc="model.security.Permission" fkcolumn="FK_roleID" linktable="rolePermissions" inversejoincolumn="FK_permissionID";

	// O2M -> Users
	property name="Users" singularName="user" fieldtype="one-to-many" type="array" lazy="extra" batchsize="25"
			 cfc="model.security.User" fkcolumn="FK_roleID" inverse="true";
	// Calculated Fields
