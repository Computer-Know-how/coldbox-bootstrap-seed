...
* I am a user entity
*/
component persistent="true" entityname="user" table="users" batchsize="25"{
	...
	property name="username"	length="255" notnull="true" index="idx_login" unique="true";
	property name="password"	length="100" notnull="true" index="idx_login";
	property name="isActive" 	ormtype="boolean"   notnull="true" default="true" dbdefault="0" index="idx_login,idx_active";
	...
	// M20 -> Role
	property name="role" notnull="true" fieldtype="many-to-one" cfc="model.security.Role" fkcolumn="FK_roleID" lazy="true";
	...
	property name="permissions" singularName="permission" fieldtype="many-to-many" type="array" lazy="extra"
			 cfc="model.security.Permission" cascade="all"
